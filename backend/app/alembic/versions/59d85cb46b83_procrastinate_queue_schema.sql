-- Procrastinate 3.9.0 background-job queue schema, vendored verbatim and
-- frozen here so this migration is self-contained and reproducible
-- regardless of the installed Procrastinate version.
-- Source: the procrastinate package's sql/schema.sql.
